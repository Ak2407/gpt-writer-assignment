...
const GenerateButton = ({ type, disabled }: GenerateButtonProps) => {
  ...
  return (
    <div className="">
      <button
        type={type}
        onClick={generated ? undefined : handleClick}
        className="bg-primaryBtn rounded-[5px] flex flex-row gap-2 items-center justify-center py-[5px] px-[13px] text-normal hover:opacity-80 transition-all ease-in-out duration-200 disabled:opacity-80 text-white "
        disabled={disabled}
      >
        {!generated ? (
