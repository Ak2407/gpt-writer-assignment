...
const InsertButton = ({ onClick }: InsertButtonProps) => {
  return (
    <div className="">
      <button
        onClick={onClick}
        className="bg-transparent border border-slate-500 text-slate-500 rounded-[5px] flex flex-row gap-2 items-center justify-center py-1 px-2 text-normal font-medium hover:opacity-80 duration-200 transition-all ease-in-out "
      >
        <svg
          width="10"
          height="10"
